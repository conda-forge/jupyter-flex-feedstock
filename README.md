...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-flex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10802&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-flex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-flex` can be installed with:

```
conda install jupyter-flex
```

It is possible to list all of the versions of `jupyter-flex` available on your platform with:
